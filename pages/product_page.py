...
class ProductPage(BasePage):
    ...
    def is_add_to_cart_visible(self) -> bool:
        try:
            self.page.wait_for_selector(self.ADD_TO_CART_BUTTON, state="visible", timeout=5000)
            return True
        except:
            return False
    ...
    def is_add_to_wishlist_visible(self) -> bool:
        try:
            self.page.wait_for_selector(self.ADD_TO_WISHLIST_BUTTON, state="visible", timeout=5000)
            return True
        except:
            return False
    ...
    def is_add_to_compare_visible(self) -> bool:
        try:
            self.page.wait_for_selector(self.ADD_TO_COMPARE_BUTTON, state="visible", timeout=5000)
            return True
        except:
            return False
